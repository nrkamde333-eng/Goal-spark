  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex relative flex-col justify-between p-12 overflow-hidden gradient-brand text-white">
        ...
        <div className="absolute -top-40 -left-40 size-125 rounded-full bg-white/10 blur-3xl" />
        ...
        <div className="relative">
          ...
          <p className="mt-4 opacity-90 max-w-md">
            Your AI productivity coach that turns any goal into daily action.
          </p>
          <div className="mt-10 space-y-3 max-w-md">
            {[
              "AI-generated roadmaps in seconds",
              "Smart calendar that adapts to your life",
              "Habits + analytics that keep you honest",
            ].map((s) => (
              <div key={s} className="flex items-center gap-3 text-sm">
                <div className="size-5 rounded-full bg-white/20 grid place-items-center text-xs">
                  ✓
                </div>
                {s}
              </div>
        ...
        <div className="relative text-xs opacity-80">
          © {new Date().getFullYear()} GoalPilot
        </div>
      </div>
              ...
              <form onSubmit={submit} className="mt-6 space-y-4">
                <Field label="Email">
                  <Input
                    ...
                    defaultValue="alex@goalpilot.ai"
                  />
                </Field>
